...
namespace ShapeCalculator.Core.Tests.Services
{
    public class ShapeServiceTests
    {
        ...
        public void GivenShapeIsTriangleWhenProcessingLeftTriangleThenNumberOfCoordinatesIs3()
        {
            ...
            var shape = _shapeService.ProcessLeftSidedTriangle(grid, gridValue);
        ...
        public void GivenGridValueA2AndGridSize10WhenProcessingRightTriangleThenCoordinatesAreValid()
        {
            ...
            var shape = _shapeService.ProcessRightSidedTriangle(grid, gridValue);
